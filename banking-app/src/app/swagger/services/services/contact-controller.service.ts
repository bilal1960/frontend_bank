...
import { findAllByUserId1 } from '../fn/contact-controller/find-all-by-user-id-1';
import { FindAllByUserId1$Params } from '../fn/contact-controller/find-all-by-user-id-1';
